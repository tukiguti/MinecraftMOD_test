...
@Mod("exampletnt")
@Mod.EventBusSubscriber(modid = "exampletnt", bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class Hud {
    private static final ResourceLocation LEVEL_BAR_FRAME = new ResourceLocation("exampletnt", "textures/bar/level_bar_frame.png");
    private static final ResourceLocation LEVEL_BAR = new ResourceLocation("exampletnt", "textures/bar/level_bar.png");
